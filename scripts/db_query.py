...
def main():
    ...
    parser.add_argument("--danfe-output")
    ...
    parser.add_argument("--csc-id")
    parser.add_argument("--serie-default")
    parser.add_argument("--proximo-numero", type=int)
    parser.add_argument("--regime-tributario")
    parser.add_argument("--regime-isencao")
    parser.add_argument("--tipo-emissao")
    parser.add_argument("--sales-invoice-id")
    parser.add_argument("--nfe-out-id")
    parser.add_argument("--data-saida")
    parser.add_argument("--hora-saida")
    parser.add_argument("--natureza-operacao")
    parser.add_argument("--finalidade")
    parser.add_argument("--justificativa")
    parser.add_argument("--correcao")
    parser.add_argument("--numero-inicial", type=int)
    parser.add_argument("--numero-final", type=int)
    parser.add_argument("--cnpj")
    parser.add_argument("--dFe-id")
